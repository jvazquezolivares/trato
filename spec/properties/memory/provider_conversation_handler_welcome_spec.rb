...
# Feature: trato-mvp, Property 3: ProviderConversationHandler sends welcome for unknown senders
...
RSpec.describe ProviderConversationHandler, "P3: welcome on unknown sender", type: :property do
  ...
  context "when sender is unknown and body matches no provider" do
    PropertyTestHelper::MEMORY_ITERATIONS.times do |iteration|
      it "sends the welcome message (iteration #{iteration + 1})" do
        ...
        ProviderConversationHandler.call(from: unknown_phone, body: random_body, media_url: nil)
    ...
    it "never routes to ProviderAssistant" do
      ProviderConversationHandler.call(from: "5210000000000", body: "hola", media_url: nil)
  ...
  context "when sender already received welcome and responds with any message" do
    ...
    it "routes any response directly to OnboardingService" do
